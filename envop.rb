...
class Envop < Formula
  ...
  on_macos do
    if Hardware::CPU.intel?
      url "https://github.com/alexanderflink/envop/releases/download/v1.0.4/envop-x86_64-macos.tar.gz"
    ...
    if Hardware::CPU.arm?
      url "https://github.com/alexanderflink/envop/releases/download/v1.0.4/envop-aarch64-macos.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/alexanderflink/envop/releases/download/v1.0.4/envop-x86_64-linux.tar.gz"
